<template>
  ...
  <aside
    v-if="!isMobile"
    class="hidden lg:block fixed right-0 top-0 h-screen w-96 bg-gray-800 border-l border-gray-700 shadow-2xl overflow-y-auto z-40 transition-transform duration-300 ease-in-out"
  ...
  >
    <div class="p-4">
      <!-- Header -->
      <div class="sticky top-0 bg-gray-800 border-b border-gray-700 px-4 py-4 z-10 backdrop-blur-sm bg-opacity-95 shadow-sm">
        <div class="flex items-center justify-between">
          ...
          <button
            @click="$emit('close')"
            class="text-gray-400 hover:text-gray-200 transition-all p-2 rounded-lg hover:bg-red-900/20 border border-gray-600 hover:border-red-700"
      ...
      <div class="p-4">
        <!-- Empty State -->
      <div v-if="!activeThread" class="text-center py-12 text-gray-400">
      ...
      <div v-else class="space-y-4">
        <!-- Thread Header -->
        <div class="bg-gradient-to-r from-gray-700 to-gray-800 rounded-lg p-4 border border-gray-600 shadow-sm mb-4">
          <div class="flex items-center justify-between mb-2">
            ...
            <span
              ...
              class="inline-flex items-center gap-1 px-2.5 py-1 text-xs font-medium bg-green-900/40 text-green-300 rounded-full shadow-sm"
            >
        ...
        <div class="space-y-3">
          ...
          >
            ...
            <!-- Message Actions -->
            <div v-if="canEditMessage(message)" class="flex items-center gap-2 mt-2 pt-2 border-t border-gray-700">
              <button
            ...
            <div v-if="message.editing" class="mt-2">
              <textarea
                ...
                class="w-full px-2 py-1 text-sm border border-gray-600 rounded-md bg-gray-700 text-gray-100 resize-none"
                rows="3"
              ></textarea>
              <div class="flex items-center gap-2 mt-2">
                ...
                <button
                  ...
                  class="px-2 py-1 text-xs bg-gray-600 text-gray-300 rounded hover:bg-gray-500"
                >
                  Cancel
                </button>
              </div>
        ...
        <div class="bg-gray-700/50 rounded-lg p-3 border border-gray-600">
          <textarea
            ...
            class="w-full px-3 py-2 text-sm border border-gray-600 rounded-md bg-gray-800 text-gray-100 placeholder-gray-500 resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            rows="3"
  ...
  <Teleport to="body">
    ...
    >
      ...
      <!-- Slide-over Panel -->
      <div
        class="absolute right-0 top-0 h-full w-full max-w-sm bg-gray-800 shadow-xl overflow-y-auto"
        role="dialog"
        aria-modal="true"
      ...
      >
        <div class="p-4">
          ...
          <div class="flex items-center justify-between mb-4">
            <h2 id="sidebar-title" class="text-lg font-semibold text-gray-100">
              Inline Comments
            </h2>
            <button
              @click="$emit('close')"
          ...
          <div v-else class="space-y-4">
            ...
            <div class="bg-gray-700/50 rounded-lg p-3 border border-gray-600">
              <div class="flex items-center justify-between mb-2">
                ...
                <span
                  v-if="activeThread.resolved"
                  class="inline-flex items-center gap-1 px-2 py-0.5 text-xs bg-green-900/30 text-green-300 rounded-full"
                >
                  <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                  </svg>
