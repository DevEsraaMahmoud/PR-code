<template>
    <AppLayout>
        <div class="max-w-4xl mx-auto">
            <h1 class="text-3xl font-bold text-gray-100 mb-8">Create New Post</h1>
            <form @submit.prevent="submit" class="bg-gray-800 rounded-xl shadow-md p-8 border border-gray-700">
                ...
                <div class="flex space-x-4">
                    ...
                    <Link href="/" class="px-6 py-3 bg-gray-700 text-gray-300 font-semibold rounded-lg hover:bg-gray-600 transition-colors">
                        Cancel
                    </Link>
                </div>
            </form>
